...
DEPRECATED(static rb_inline void rb_disable_super(void));
DEPRECATED(static rb_inline void rb_enable_super(void));
static rb_inline void rb_disable_super(void)
{
    /* obsolete - no use */
}
static rb_inline void rb_enable_super(void)
{
