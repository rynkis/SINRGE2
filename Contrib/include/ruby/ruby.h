...
RUBY_UNTYPED_DATA_FUNC(static rb_inline VALUE rb_data_object_alloc_warning(VALUE,void*,RUBY_DATA_FUNC,RUBY_DATA_FUNC));
RUBY_UNTYPED_DATA_FUNC(static rb_inline void *rb_data_object_get_warning(VALUE));
