...
///////////////////////////////////////////////////////////////////////////////////////////////////
extern "C" __declspec(dllexport) IPackage* create(const Char* filename, const Char * password, u32 chunkSize = 0x40000, u32 fileUserDataSize = 0);
extern "C" __declspec(dllexport) IPackage* open(const Char* filename, const Char * password, u32 flag = OPEN_READONLY | OPEN_NO_FILENAME);
extern "C" __declspec(dllexport) void close(IPackage* package);

//IPackage* create(const Char* filename, const Char * password, u32 chunkSize = 0x40000, u32 fileUserDataSize = 0);
//IPackage* open(const Char* filename, const Char * password, u32 flag = OPEN_READONLY | OPEN_NO_FILENAME);
