...
#define SET_ARGB_A(col,a)		col = ((col & 0x00FFFFFF) + (a << 24))
#define SET_ARGB_R(col,r)		col = ((col & 0xFF00FFFF) + (r << 16))
#define SET_ARGB_G(col,g)		col = ((col & 0xFFFF00FF) + (g << 8))
#define SET_ARGB_B(col,b)		col = ((col & 0xFFFFFF00) + b)
