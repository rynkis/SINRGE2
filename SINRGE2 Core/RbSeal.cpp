...
static VALUE alloc_##obj(VALUE klass)                                       \
{                                                                           \
...
static void check_seal_err(seal_err_t err)
{
    if (err != SEAL_OK)
...
static seal_fmt_t map_format(VALUE symbol)
{
    if (NIL_P(symbol))
...
static VALUE set_listener_3float(VALUE rarr, seal_err_t (*set)(float, float, float))
{
    float x, y, z;
...
static VALUE startup(int argc, VALUE* argv)
{
    ...
    check_seal_err(seal_startup(NIL_P(rstring) ? 0 : rb_string_value_ptr(&rstring)));
 ...
 */
static VALUE per_source_effect_limit()
{
 ...
 */
static VALUE get_buf_size(VALUE rbuf)
{
 ...
 */
static VALUE get_buf_freq(VALUE rbuf)
{
 ...
 */
static VALUE get_buf_bps(VALUE rbuf)
{
 ...
 */
static VALUE get_buf_nchannels(VALUE rbuf)
{
 ...
 */
static VALUE get_stream_freq(VALUE rstream)
{
 ...
 */
static VALUE get_stream_bps(VALUE rstream)
{
 ...
 */
static VALUE get_stream_nchannels(VALUE rstream)
{
 ...
 * State::PLAYING.
 */
static VALUE play_src(VALUE rsrc)
{
 ...
 */
static VALUE pause_src(VALUE rsrc)
{
 ...
 */
static VALUE stop_src(VALUE rsrc)
{
 ...
 */
static VALUE rewind_src(VALUE rsrc)
{
 ...
 *      end
 */
static VALUE move_src(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE get_src_buf(VALUE rsrc)
{
 ...
 */
static VALUE get_src_stream(VALUE rsrc)
{
 ...
 */
static VALUE set_src_pos(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE get_src_pos(VALUE rsrc)
{
 ...
 */
static VALUE set_src_vel(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE get_src_vel(VALUE rsrc)
{
 ...
 * (0.0, +inf.).
 */
static VALUE set_src_pitch(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE get_src_pitch(VALUE rsrc)
{
 ...
 */
static VALUE set_src_gain(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE get_src_gain(VALUE rsrc)
{
 ...
 */
static VALUE set_src_auto(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE is_src_auto(VALUE rsrc)
{
 ...
 */
static VALUE set_src_relative(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE is_src_relative(VALUE rsrc)
{
 ...
 */
static VALUE set_src_looping(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE is_src_looping(VALUE rsrc)
{
 ...
 * interval [2, 63].
 */
static VALUE set_src_queue_size(VALUE rsrc, VALUE value)
{
 ...
 */
static VALUE get_src_queue_size(VALUE rsrc)
{
 ...
 */
static VALUE set_src_chunk_size(VALUE rsrc, VALUE value)
{
 ...
 * 36864.
 */
static VALUE get_src_chunk_size(VALUE rsrc)
{
 ...
 */
static VALUE get_src_type(VALUE rsrc)
{
 ...
 */
static VALUE get_src_state(VALUE rsrc)
{
 ...
 * the more coloration.
 */
static VALUE set_rvb_density(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_density(VALUE rrvb)
{
 ...
 */
static VALUE set_rvb_diffusion(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_diffusion(VALUE rrvb)
{
 ...
 * mix.
 */
static VALUE set_rvb_gain(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_gain(VALUE rrvb)
{
 ...
 * reverb effect.
 */
static VALUE set_rvb_hfgain(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_hfgain(VALUE rrvb)
{
 ...
 * surfaces.
 */
static VALUE set_rvb_decay_time(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_decay_time(VALUE rrvb)
{
 ...
 * reverberation.
 */
static VALUE set_rvb_hfdecay_ratio(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_hfdecay_ratio(VALUE rrvb)
{
 ...
 * reflections.
 */
static VALUE set_rvb_reflections_gain(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_reflections_gain(VALUE rrvb)
{
 ...
 */
static VALUE set_rvb_reflections_delay(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_reflections_delay(VALUE rrvb)
{
 ...
 * constant.
 */
static VALUE set_rvb_late_gain(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_late_gain(VALUE rrvb)
{
 ...
 */
static VALUE set_rvb_late_delay(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_late_delay(VALUE rrvb)
{
 ...
 */
static VALUE set_rvb_air_absorbtion_hfgain(VALUE rrvb, VALUE value)
{
 ...
 * 0.994.
 */
static VALUE get_rvb_air_absorbtion_hfgain(VALUE rrvb)
{
 ...
 */
static VALUE set_rvb_room_rolloff_factor(VALUE rrvb, VALUE value)
{
 ...
 */
static VALUE get_rvb_room_rolloff_factor(VALUE rrvb)
{
 ...
 */
static VALUE set_rvb_hfdecay_limited(VALUE rrvb, VALUE value)
{
 ...
 * is true.
 */
static VALUE is_rvb_hfdecay_limited(VALUE rrvb)
{
 ...
 */
static VALUE get_efs_effect(VALUE rslot)
{
 ...
 */
static VALUE set_efs_gain(VALUE refs, VALUE value)
{
 ...
 */
static VALUE get_efs_gain(VALUE refs)
{
 ...
 */
static VALUE set_efs_auto(VALUE refs, VALUE value)
{
 ...
 * (nonzero).
 */
static VALUE is_efs_auto(VALUE refs)
{
 ...
 */
static VALUE get_listener()
{
    return rb_const_get(mSeal, rb_intern("LISTENER"));
}

static VALUE move_listener(VALUE rlistener)
{
 ...
 */
static VALUE set_listener_gain(VALUE rlistener, VALUE value)
{
 ...
 */
static VALUE get_listener_gain(VALUE rlistener, VALUE value)
{
 ...
 * system. Use of NaN and infinity is undefined.
 */
static VALUE set_listener_pos(VALUE rlistener, VALUE value)
{
 ...
 */
static VALUE get_listener_pos(VALUE rlistener, VALUE value)
{
 ...
 */
static VALUE set_listener_vel(VALUE rlistener, VALUE value)
{
 ...
 */
static VALUE get_listener_vel(VALUE rlistener, VALUE value)
{
 ...
 */
static VALUE set_listener_orien(VALUE rlistener, VALUE rarr)
{
    float orien[6];
 ...
 */
static VALUE get_listener_orien(VALUE rlistener)
{
    float tuple[6];
    VALUE rtuple[6];
    VALUE orien[2];
...
static void singletonify(VALUE klass)
{
...
static void bind_core(void)
{
    ...
    rb_define_singleton_method(mSeal, "startup", RbFunc(startup), -1);
    rb_define_singleton_method(mSeal, "cleanup", RbFunc(cleanup), 0);
    rb_define_singleton_method(mSeal, "per_source_effect_limit", RbFunc(per_source_effect_limit), 0);
 ...
 */
static void bind_buf(void)
{
    VALUE cBuffer = rb_define_class_under(mSeal, "Buffer", rb_cObject);

    rb_define_alloc_func(cBuffer, alloc_buf);
    rb_define_method(cBuffer, "initialize", RbFunc(init_buf), -1);
    rb_define_method(cBuffer, "load", RbFunc(load_buf), -1);
    rb_define_method(cBuffer, "size", RbFunc(get_buf_size), 0);
    rb_define_method(cBuffer, "frequency", RbFunc(get_buf_freq), 0);
    rb_define_method(cBuffer, "bit_depth", RbFunc(get_buf_bps), 0);
    rb_define_method(cBuffer, "channel_count", RbFunc(get_buf_nchannels), 0);
}
 ...
 */
static void bind_stream(void)
{
    VALUE cStream = rb_define_class_under(mSeal, "Stream", rb_cObject);

    rb_define_alloc_func(cStream, alloc_stream);
    rb_define_method(cStream, "initialize", RbFunc(init_stream), -1);
    rb_define_method(cStream, "frequency", RbFunc(get_stream_freq), 0);
    rb_define_method(cStream, "bit_depth", RbFunc(get_stream_bps), 0);
    rb_define_method(cStream, "channel_count", RbFunc(get_stream_nchannels), 0);
    rb_define_method(cStream, "rewind", RbFunc(rewind_stream), 0);
    rb_define_method(cStream, "close", RbFunc(close_stream), 0);
...
static void bind_src(void)
{
    ...
    rb_define_method(cSource, "initialize", RbFunc(init_src), 0);
    rb_define_method(cSource, "play", RbFunc(play_src), 0);
    rb_define_method(cSource, "pause", RbFunc(pause_src), 0);
    rb_define_method(cSource, "stop", RbFunc(stop_src), 0);
    rb_define_method(cSource, "rewind", RbFunc(rewind_src), 0);
    rb_define_method(cSource, "move", RbFunc(move_src), 0);
    rb_define_method(cSource, "buffer=", RbFunc(set_src_buf), 1);
    rb_define_method(cSource, "buffer", RbFunc(get_src_buf), 0);
    rb_define_method(cSource, "stream=", RbFunc(set_src_stream), 1);
    rb_define_method(cSource, "stream", RbFunc(get_src_stream), 0);
    rb_define_method(cSource, "feed", RbFunc(feed_efs), 2);
    rb_define_method(cSource, "update", RbFunc(update_src), 0);
    rb_define_method(cSource, "position=", RbFunc(set_src_pos), 1);
    rb_define_method(cSource, "position", RbFunc(get_src_pos), 0);
    rb_define_method(cSource, "velocity=", RbFunc(set_src_vel), 1);
    rb_define_method(cSource, "velocity", RbFunc(get_src_vel), 0);
    rb_define_method(cSource, "pitch=", RbFunc(set_src_pitch), 1);
    rb_define_method(cSource, "pitch", RbFunc(get_src_pitch), 0);
    rb_define_method(cSource, "gain=", RbFunc(set_src_gain), 1);
    rb_define_method(cSource, "gain", RbFunc(get_src_gain), 0);
    rb_define_method(cSource, "auto=", RbFunc(set_src_auto), 1);
    rb_define_method(cSource, "auto", RbFunc(is_src_auto), 0);
    rb_define_alias(cSource, "auto?", "auto");
    rb_define_method(cSource, "relative=", RbFunc(set_src_relative), 1);
    rb_define_method(cSource, "relative", RbFunc(is_src_relative), 0);
    rb_define_alias(cSource, "relative?", "relative");
    rb_define_method(cSource, "looping=", RbFunc(set_src_looping), 1);
    rb_define_method(cSource, "looping", RbFunc(is_src_looping), 0);
    rb_define_alias(cSource, "looping?", "looping");
    rb_define_method(cSource, "queue_size=", RbFunc(set_src_queue_size), 1);
    rb_define_method(cSource, "queue_size", RbFunc(get_src_queue_size), 0);
    rb_define_method(cSource, "chunk_size=", RbFunc(set_src_chunk_size), 1);
    rb_define_method(cSource, "chunk_size", RbFunc(get_src_chunk_size), 0);
    rb_define_method(cSource, "type", RbFunc(get_src_type), 0);
    rb_define_method(cSource, "state", RbFunc(get_src_state), 0);
...
static void bind_rvb(void)
{
    ...
    rb_define_method(cReverb, "initialize", RbFunc(init_rvb), -1);
    rb_define_method(cReverb, "load", RbFunc(load_rvb), 1);
    rb_define_method(cReverb, "density=", RbFunc(set_rvb_density), 1);
    rb_define_method(cReverb, "density", RbFunc(get_rvb_density), 0);
    rb_define_method(cReverb, "diffusion=", RbFunc(set_rvb_diffusion), 1);
    rb_define_method(cReverb, "diffusion", RbFunc(get_rvb_diffusion), 0);
    rb_define_method(cReverb, "gain=", RbFunc(set_rvb_gain), 1);
    rb_define_method(cReverb, "gain", RbFunc(get_rvb_gain), 0);
    rb_define_method(cReverb, "hfgain=", RbFunc(set_rvb_hfgain), 1);
    rb_define_method(cReverb, "hfgain", RbFunc(get_rvb_hfgain), 0);
    rb_define_method(cReverb, "decay_time=", RbFunc(set_rvb_decay_time), 1);
    rb_define_method(cReverb, "decay_time", RbFunc(get_rvb_decay_time), 0);
    rb_define_method(cReverb, "hfdecay_ratio=", RbFunc(set_rvb_hfdecay_ratio), 1);
    rb_define_method(cReverb, "hfdecay_ratio", RbFunc(get_rvb_hfdecay_ratio), 0);
    rb_define_method(cReverb, "reflections_gain=", RbFunc(set_rvb_reflections_gain), 1);
    rb_define_method(cReverb, "reflections_gain", RbFunc(get_rvb_reflections_gain), 0);
    rb_define_method(cReverb, "reflections_delay=", RbFunc(set_rvb_reflections_delay), 1);
    rb_define_method(cReverb, "reflections_delay", RbFunc(get_rvb_reflections_delay), 0);
    rb_define_method(cReverb, "late_gain=", RbFunc(set_rvb_late_gain), 1);
    rb_define_method(cReverb, "late_gain", RbFunc(get_rvb_late_gain), 0);
    rb_define_method(cReverb, "late_delay=", RbFunc(set_rvb_late_delay), 1);
    rb_define_method(cReverb, "late_delay", RbFunc(get_rvb_late_delay), 0);
    rb_define_method(cReverb, "air_absorbtion_hfgain=", RbFunc(set_rvb_air_absorbtion_hfgain), 1);
    rb_define_method(cReverb, "air_absorbtion_hfgain", RbFunc(get_rvb_air_absorbtion_hfgain), 0);
    rb_define_method(cReverb, "room_rolloff_factor=", RbFunc(set_rvb_room_rolloff_factor), 1);
    rb_define_method(cReverb, "room_rolloff_factor", RbFunc(get_rvb_room_rolloff_factor), 0);
    rb_define_method(cReverb, "hfdecay_limited=", RbFunc(set_rvb_hfdecay_limited), 1);
    rb_define_method(cReverb, "hfdecay_limited", RbFunc(is_rvb_hfdecay_limited), 0);
    ...
    rb_define_const(mPreset, "CARPETEDHALLWAY", INT2NUM(SEAL_CARPETEDHALLWAY_REVERB));
    rb_define_const(mPreset, "HALLWAY", INT2NUM(SEAL_HALLWAY_REVERB));
    rb_define_const(mPreset, "STONECORRIDOR", INT2NUM(SEAL_STONECORRIDOR_REVERB));
    ...
    rb_define_const(mCastle, "SMALLROOM", INT2NUM(SEAL_CASTLE_SMALLROOM_REVERB));
    rb_define_const(mCastle, "SHORTPASSAGE", INT2NUM(SEAL_CASTLE_SHORTPASSAGE_REVERB));
    rb_define_const(mCastle, "MEDIUMROOM", INT2NUM(SEAL_CASTLE_MEDIUMROOM_REVERB));
    rb_define_const(mCastle, "LARGEROOM", INT2NUM(SEAL_CASTLE_LARGEROOM_REVERB));
    rb_define_const(mCastle, "LONGPASSAGE", INT2NUM(SEAL_CASTLE_LONGPASSAGE_REVERB));
    ...
    rb_define_const(mCastle, "COURTYARD", INT2NUM(SEAL_CASTLE_COURTYARD_REVERB));
    rb_define_const(mCastle, "ALCOVE", INT2NUM(SEAL_CASTLE_ALCOVE_REVERB));

    rb_define_const(mFactory, "SMALLROOM", INT2NUM(SEAL_FACTORY_SMALLROOM_REVERB));
    rb_define_const(mFactory, "SHORTPASSAGE", INT2NUM(SEAL_FACTORY_SHORTPASSAGE_REVERB));
    rb_define_const(mFactory, "MEDIUMROOM", INT2NUM(SEAL_FACTORY_MEDIUMROOM_REVERB));
    rb_define_const(mFactory, "LARGEROOM", INT2NUM(SEAL_FACTORY_LARGEROOM_REVERB));
    rb_define_const(mFactory, "LONGPASSAGE", INT2NUM(SEAL_FACTORY_LONGPASSAGE_REVERB));
    rb_define_const(mFactory, "HALL", INT2NUM(SEAL_FACTORY_HALL_REVERB));
    rb_define_const(mFactory, "CUPBOARD", INT2NUM(SEAL_FACTORY_CUPBOARD_REVERB));
    rb_define_const(mFactory, "COURTYARD", INT2NUM(SEAL_FACTORY_COURTYARD_REVERB));
    rb_define_const(mFactory, "ALCOVE", INT2NUM(SEAL_FACTORY_ALCOVE_REVERB));

    rb_define_const(mIcePalace, "SMALLROOM", INT2NUM(SEAL_ICEPALACE_SMALLROOM_REVERB));
    rb_define_const(mIcePalace, "SHORTPASSAGE", INT2NUM(SEAL_ICEPALACE_SHORTPASSAGE_REVERB));
    rb_define_const(mIcePalace, "MEDIUMROOM", INT2NUM(SEAL_ICEPALACE_MEDIUMROOM_REVERB));
    rb_define_const(mIcePalace, "LARGEROOM", INT2NUM(SEAL_ICEPALACE_LARGEROOM_REVERB));
    rb_define_const(mIcePalace, "LONGPASSAGE", INT2NUM(SEAL_ICEPALACE_LONGPASSAGE_REVERB));
    rb_define_const(mIcePalace, "HALL", INT2NUM(SEAL_ICEPALACE_HALL_REVERB));
    rb_define_const(mIcePalace, "CUPBOARD", INT2NUM(SEAL_ICEPALACE_CUPBOARD_REVERB));
    rb_define_const(mIcePalace, "COURTYARD", INT2NUM(SEAL_ICEPALACE_COURTYARD_REVERB));
    rb_define_const(mIcePalace, "ALCOVE", INT2NUM(SEAL_ICEPALACE_ALCOVE_REVERB));

    rb_define_const(mSpaceStation, "SMALLROOM", INT2NUM(SEAL_SPACESTATION_SMALLROOM_REVERB));
    rb_define_const(mSpaceStation, "SHORTPASSAGE", INT2NUM(SEAL_SPACESTATION_SHORTPASSAGE_REVERB));
    rb_define_const(mSpaceStation, "MEDIUMROOM", INT2NUM(SEAL_SPACESTATION_MEDIUMROOM_REVERB));
    rb_define_const(mSpaceStation, "LARGEROOM", INT2NUM(SEAL_SPACESTATION_LARGEROOM_REVERB));
    rb_define_const(mSpaceStation, "LONGPASSAGE", INT2NUM(SEAL_SPACESTATION_LONGPASSAGE_REVERB));
    rb_define_const(mSpaceStation, "HALL", INT2NUM(SEAL_SPACESTATION_HALL_REVERB));
    rb_define_const(mSpaceStation, "CUPBOARD", INT2NUM(SEAL_SPACESTATION_CUPBOARD_REVERB));
    rb_define_const(mSpaceStation, "ALCOVE", INT2NUM(SEAL_SPACESTATION_ALCOVE_REVERB));
    rb_define_const(mWoodenGalleon, "SMALLROOM", INT2NUM(SEAL_WOODEN_SMALLROOM_REVERB));
    rb_define_const(mWoodenGalleon, "SHORTPASSAGE", INT2NUM(SEAL_WOODEN_SHORTPASSAGE_REVERB));
    rb_define_const(mWoodenGalleon, "MEDIUMROOM", INT2NUM(SEAL_WOODEN_MEDIUMROOM_REVERB));
    rb_define_const(mWoodenGalleon, "LARGEROOM", INT2NUM(SEAL_WOODEN_LARGEROOM_REVERB));
    rb_define_const(mWoodenGalleon, "LONGPASSAGE", INT2NUM(SEAL_WOODEN_LONGPASSAGE_REVERB));
    rb_define_const(mWoodenGalleon, "HALL", INT2NUM(SEAL_WOODEN_HALL_REVERB));
    rb_define_const(mWoodenGalleon, "CUPBOARD", INT2NUM(SEAL_WOODEN_CUPBOARD_REVERB));
    rb_define_const(mWoodenGalleon, "COURTYARD", INT2NUM(SEAL_WOODEN_COURTYARD_REVERB));
    rb_define_const(mWoodenGalleon, "ALCOVE", INT2NUM(SEAL_WOODEN_ALCOVE_REVERB));

    rb_define_const(mSports, "EMPTYSTADIUM", INT2NUM(SEAL_SPORT_EMPTYSTADIUM_REVERB));
    rb_define_const(mSports, "SQUASHCOURT", INT2NUM(SEAL_SPORT_SQUASHCOURT_REVERB));
    rb_define_const(mSports, "SMALLSWIMMINGPOOL", INT2NUM(SEAL_SPORT_SMALLSWIMMINGPOOL_REVERB));
    rb_define_const(mSports, "LARGESWIMMINGPOOL", INT2NUM(SEAL_SPORT_LARGESWIMMINGPOOL_REVERB));
    rb_define_const(mSports, "GYMNASIUM", INT2NUM(SEAL_SPORT_GYMNASIUM_REVERB));
    rb_define_const(mSports, "FULLSTADIUM", INT2NUM(SEAL_SPORT_FULLSTADIUM_REVERB));
    rb_define_const(mSports, "STADIUMTANNOY", INT2NUM(SEAL_SPORT_STADIUMTANNOY_REVERB));

    rb_define_const(mPrefab, "WORKSHOP", INT2NUM(SEAL_PREFAB_WORKSHOP_REVERB));
    rb_define_const(mPrefab, "SCHOOLROOM", INT2NUM(SEAL_PREFAB_SCHOOLROOM_REVERB));
    rb_define_const(mPrefab, "PRACTISEROOM", INT2NUM(SEAL_PREFAB_PRACTISEROOM_REVERB));
    ...
    rb_define_const(mOutdoors, "BACKYARD", INT2NUM(SEAL_OUTDOORS_BACKYARD_REVERB));
    rb_define_const(mOutdoors, "ROLLINGPLAINS", INT2NUM(SEAL_OUTDOORS_ROLLINGPLAINS_REVERB));
    rb_define_const(mOutdoors, "DEEPCANYON", INT2NUM(SEAL_OUTDOORS_DEEPCANYON_REVERB));
    rb_define_const(mOutdoors, "CREEK", INT2NUM(SEAL_OUTDOORS_CREEK_REVERB));
    rb_define_const(mOutdoors, "VALLEY", INT2NUM(SEAL_OUTDOORS_VALLEY_REVERB));

    rb_define_const(mMood, "HEAVEN", INT2NUM(SEAL_MOOD_HEAVEN_REVERB));
    rb_define_const(mMood, "HELL", INT2NUM(SEAL_MOOD_HELL_REVERB));
    rb_define_const(mMood, "MEMORY", INT2NUM(SEAL_MOOD_MEMORY_REVERB));

    rb_define_const(mDriving, "COMMENTATOR", INT2NUM(SEAL_DRIVING_COMMENTATOR_REVERB));
    rb_define_const(mDriving, "PITGARAGE", INT2NUM(SEAL_DRIVING_PITGARAGE_REVERB));
    rb_define_const(mDriving, "INCAR_RACER", INT2NUM(SEAL_DRIVING_INCAR_RACER_REVERB));
    rb_define_const(mDriving, "INCAR_SPORTS", INT2NUM(SEAL_DRIVING_INCAR_SPORTS_REVERB));
    rb_define_const(mDriving, "INCAR_LUXURY", INT2NUM(SEAL_DRIVING_INCAR_LUXURY_REVERB));
    rb_define_const(mDriving, "FULLGRANDSTAND", INT2NUM(SEAL_DRIVING_FULLGRANDSTAND_REVERB));
    rb_define_const(mDriving, "EMPTYGRANDSTAND", INT2NUM(SEAL_DRIVING_EMPTYGRANDSTAND_REVERB));
    ...
    rb_define_const(mMisc, "SMALLWATERROOM", INT2NUM(SEAL_SMALLWATERROOM_REVERB));
}
 ...
 * extension guide at: http://zhang.su/seal/EffectsExtensionGuide.pdf
 */
static void bind_efs(void)
{
    VALUE cEffectSlot = rb_define_class_under(mSeal, "EffectSlot", rb_cObject);

    rb_define_alloc_func(cEffectSlot, alloc_efs);
    rb_define_method(cEffectSlot, "initialize", RbFunc(init_efs), -1);
    rb_define_method(cEffectSlot, "effect=", RbFunc(set_efs_effect), 1);
    rb_define_method(cEffectSlot, "effect", RbFunc(get_efs_effect), 0);
    rb_define_method(cEffectSlot, "gain=", RbFunc(set_efs_gain), 1);
    rb_define_method(cEffectSlot, "gain", RbFunc(get_efs_gain), 0);
    rb_define_method(cEffectSlot, "auto=", RbFunc(set_efs_auto), 1);
    rb_define_method(cEffectSlot, "auto", RbFunc(is_efs_auto), 0);
...
static void bind_listener(void)
{
    ...
    rb_define_singleton_method(mSeal, "listener", RbFunc(get_listener), 0);
    singletonify(cListener);
    rb_define_method(cListener, "move", RbFunc(move_listener), 0);
    rb_define_method(cListener, "position=", RbFunc(set_listener_pos), 1);
    rb_define_method(cListener, "position", RbFunc(get_listener_pos), 0);
    rb_define_method(cListener, "velocity=", RbFunc(set_listener_vel), 1);
    rb_define_method(cListener, "velocity", RbFunc(get_listener_vel), 0);
    rb_define_method(cListener, "gain=", RbFunc(set_listener_gain), 1);
    rb_define_method(cListener, "gain", RbFunc(get_listener_gain), 0);
    rb_define_method(cListener, "orientation=", RbFunc(set_listener_orien), 1);
    rb_define_method(cListener, "orientation", RbFunc(get_listener_orien), 0);
}
